        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="身份证号" prop="zhuanjiaNumber">
                              <el-input v-model="ruleForm.zhuanjiaNumber"
                                        placeholder="身份证号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="身份证号" prop="zhuanjiaNumber">
                                  <el-input v-model="ruleForm.zhuanjiaNumber"
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="手机号" prop="zhuanjiaPhone">
                              <el-input v-model="ruleForm.zhuanjiaPhone"
                                        placeholder="手机号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="手机号" prop="zhuanjiaPhone">
                                  <el-input v-model="ruleForm.zhuanjiaPhone"
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="邮箱" prop="zhuanjiaEmail">
                              <el-input v-model="ruleForm.zhuanjiaEmail"
                                        placeholder="邮箱" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="邮箱" prop="zhuanjiaEmail">
                                  <el-input v-model="ruleForm.zhuanjiaEmail"
                   ...
                   <el-col :span="24">
                       <el-form-item class="upload" v-if="type!='info' && !ro.zhuanjiaPhoto" label="照片" prop="zhuanjiaPhoto">
                           <file-upload
                                   tip="点击上传照片"
                                   action="file/upload"
                                   :limit="3"
                       ...
                       <div v-else>
                           <el-form-item v-if="ruleForm.zhuanjiaPhoto" label="照片" prop="zhuanjiaPhoto">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='zhuanjiaNumber'){
                                     this.ruleForm.zhuanjiaNumber = obj[o];
                                     this.ro.zhuanjiaNumber = true;
                                     continue;
                                 }
                                 ...
                                 if(o=='zhuanjiaEmail'){
                                     this.ruleForm.zhuanjiaEmail = obj[o];
                                     this.ro.zhuanjiaEmail = true;
                                     continue;
                                 }
