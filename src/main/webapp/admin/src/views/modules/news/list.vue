        ...
        methods: {
            ...
            selectUpdate(){
                ...
                var select= {};
                              ...
                              var newsTypesSelect = this.newsTypesSelectSearch;
                    for(var i=0 ; i< newsTypesSelect.length ; i++){
                        select[ newsTypesSelect[i].codeIndex] =  newsTypesSelect[i].indexName;
                    }
                    for(var i=0 ; i<bbb.length ; i++){
                        bbb[i].newsTypes = select[bbb[i].newsTypes];
                    }
                    select = {};
