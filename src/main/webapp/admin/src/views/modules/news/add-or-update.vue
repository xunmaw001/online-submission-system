        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                       ...
                       <div v-else>
                           <el-form-item class="input" label="公告类型" prop="newsTypes">
                               <el-select v-model="ruleForm.newsTypes" placeholder="请选择公告类型" readonly>
                                   <el-option
                                           v-for="(item,index) in newsTypesSelectSearch"
                                           v-bind:key="index"
                                           :label="item.indexName"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        createTime: [
                        { required: true, message: '创建时间 show1 show2 nameShow不能为空', trigger: 'blur' },
                    ],
            },
